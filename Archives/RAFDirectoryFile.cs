...
namespace Dargon.IO.RADS.Archives {
   public unsafe class RAFDirectoryFile {
      ...
      /// </summary>
      private UInt32 offsetFileList = 0;

      /// <summary>
      /// Offset to the string table from the start of the file
      /// </summary>
      private UInt32 offsetStringTable = 0;

      private byte[] content = null;
      private RAFFileList fileList = null;
      private RAFStringTable stringTable = null;
      ...
      public RAFFileListEntry CreateFileEntry(string rafPath, UInt32 offset, UInt32 fileSize, UInt32 nameStringTableIndex) {
         RAFFileListEntry result = new RAFFileListEntry(this.riot, rafPath, offset, fileSize, nameStringTableIndex);
